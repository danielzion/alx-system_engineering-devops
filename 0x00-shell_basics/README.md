...
| `6-firstdirectory` | Creates a directory named `main` in the `/tmp/` directory |
...
| `17-tree` | Creates the directories `welcome/`, `welcome/to/` and `welcome/to/main` in the current directory |
